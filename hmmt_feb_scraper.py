...
# CONFIGURATION
# CHROMEDRIVER_PATH no longer needed - WebDriverManager will handle it automatically
BASE_URL = "https://artofproblemsolving.com"
COMP_NAME = "HMMT February"  # Updated to differentiate from HMMT November
COMP_LINK = "https://artofproblemsolving.com/community/c3417_harvardmit_mathematics_tournament"
    ...
    for div in soup.find_all("div", attrs={"class": lambda c: c and "cmty-category-cell-heading" in c}):
        ...
        if a_tag and a_tag.get("href"):
            ...
            if href.strip():
                ...
                # Filter out the current page URL and HMIC links
                if full_url != main_url and "hmic" not in full_url.lower():
...
def get_sub_forum_links(page_url, driver):
    ...
    for heading_div in heading_divs:
        ...
        if link_tag and link_tag.get("href"):
            ...
            # Filter out HMIC links and other unwanted content
            if ("hmic" in link_text.lower() or "hmic" in full_url.lower()):
                print(f"   Skipped HMIC subforum: {link_text}")
                continue
    ...
    if not sub_links:
        ...
        for rgb_div in rgb_divs:
            ...
            if link_tag and link_tag.get("href"):
                ...
                # Skip HMIC links
                if ("hmic" in link_text.lower() or "hmic" in full_url.lower()):
                    print(f"   Skipped HMIC subforum via RGB: {link_text}")
                    continue

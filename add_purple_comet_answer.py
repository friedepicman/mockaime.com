...
# === Main logic ===
input_file = "/Users/jasonyuan/Documents/git/math/Purple_Comet_problems_with_solutions_and_sources.csv"
output_file = "Purple_Comet_processed.csv"
...
# HMMT Feb starts at 9554 and has 1419 problems (9554 to 10972)
# So Purple Comet starts at 10973
df['id'] = [10973 + i for i in range(len(df))]
...
print(f"\n⚠️  Note: IDs start at 9554. Make sure this doesn't conflict with your existing database!")
print(f"   Last ID will be: {df['id'].iloc[-1] if len(df) > 0 else 'N/A'}")